...
def main() -> None:
    ...
    output.mkdir(parents=True, exist_ok=True); history: list[dict] = []; best = -1.0; patience = 0
    for epoch in range(1, int(cfg["epochs"]) + 1):
        ...
        payload = {"model": model.state_dict(), "class_ids": class_ids, "epoch": epoch, "variant": args.variant, "config": cfg, "seed": seed, "sampler": "s1_track_uniform", "internal_test_accessed": False, "outer_folds_accessed": False}
