...
def main() -> None:
    ...
    model=Pipeline([("scale",StandardScaler()),("classifier",LogisticRegression(C=1.0,solver="lbfgs",max_iter=2000,random_state=407))]); model.fit(x_train,y_train); prediction=model.predict(x_val)
